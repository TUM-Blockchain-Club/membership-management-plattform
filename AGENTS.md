...
- Newsletter campaigns use GrapesJS in the guarded `/newsletter` dashboard tab, Mailgun server-side API routes, and `newsletter_projects`. Apply `supabase/newsletter_projects.sql` before deploying newsletter UI/API changes.
