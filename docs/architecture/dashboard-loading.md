...
- The current member's Special Access result is reused for their profile. Four independent navigation permission checks run concurrently, preserving their existing database authority.
