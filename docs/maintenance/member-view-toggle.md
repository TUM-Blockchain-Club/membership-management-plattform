...
- The `Normal Member View` toggle lives in the sidebar account menu.
...
- Member creation uses the controller’s effective `canAddMember` permission for both button visibility and opening the editor. Normal Member View disables this permission, including for Board Members.
