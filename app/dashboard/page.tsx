    ...
    <div className="min-h-screen bg-black">
      ...
      <div className="relative z-10">
        ...
        <main className="max-w-7xl mx-auto px-4 sm:px-6 py-6 sm:py-8 md:py-12">
          ...
          {dashboard.activeTab === 'nft-approvals' && dashboard.showNftApprovalsTab && <NftApprovalsTab />}
          ...
          {dashboard.activeTab === 'nft-status' && <NftStatusTab member={dashboard.member} />}
        </main>
